  ...
  return (
    <>
      ...
      <Modal
        ...
        open={isOpen}
        className="share-setting-confirm-modal"
        closeIcon={false}
      ...
      >
        <Text as="span" variant="B2-Regular">
          If you change this setting, the data in this table will stop syncing
          to other bases. Any tables currently syncing data from this view will
